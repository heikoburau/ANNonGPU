...
#endif
#if defined(ENABLE_MONTE_CARLO) && defined(ENABLE_PSI_CLASSICAL) && defined(ENABLE_SPINS)
...
#endif
#if defined(ENABLE_MONTE_CARLO) && defined(ENABLE_PSI_CLASSICAL) && defined(ENABLE_SPINS) && defined(ENABLE_PSI_CLASSICAL_ANN)
...
#endif
#if defined(ENABLE_MONTE_CARLO) && defined(ENABLE_PSI_CLASSICAL_ANN) && defined(ENABLE_PAULIS) && defined(ENABLE_PSI_CLASSICAL)
...
#endif
#if defined(ENABLE_EXACT_SUMMATION) && defined(ENABLE_PSI_CLASSICAL) && defined(ENABLE_SPINS) && defined(ENABLE_PSI_CLASSICAL_ANN)
...
#endif
#if defined(ENABLE_PAULIS) && defined(ENABLE_EXACT_SUMMATION) && defined(ENABLE_PSI_CLASSICAL) && defined(ENABLE_PSI_CLASSICAL_ANN)
