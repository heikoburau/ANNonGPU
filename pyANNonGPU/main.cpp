...
PYBIND11_MODULE(_pyANNonGPU, m)
{
    ...
    py::class_<PsiDeep>(m, "PsiDeep")
        ...
        .def("_vector", [](const PsiDeep& psi, ExactSummation_t<Spins>& exact_summation) {return psi_vector_py(psi, exact_summation);})
        ...
        .def("_vector", [](const PsiDeep& psi, ExactSummation_t<PauliString>& exact_summation) {return psi_vector_py(psi, exact_summation);})
