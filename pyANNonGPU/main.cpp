...
PYBIND11_MODULE(_pyANNonGPU, m)
{
    ...
    py::class_<PsiClassicalFP<1u>>(m, "PsiClassicalFP_1")
        ...
        .def_property_readonly("M_2", [](const PsiClassicalFP<1u>& psi){return psi.M_2_op.to_expr_list();})
        .def_property_readonly("M_1_squared", [](const PsiClassicalFP<1u>& psi){return psi.M_1_squared_op.to_expr_list();})
    ...
    py::class_<PsiClassicalFP<2u>>(m, "PsiClassicalFP_2")
        ...
        .def_property_readonly("M_2", [](const PsiClassicalFP<2u>& psi){return psi.M_2_op.to_expr_list();})
        .def_property_readonly("M_1_squared", [](const PsiClassicalFP<2u>& psi){return psi.M_1_squared_op.to_expr_list();})
    ...
    py::class_<PsiClassicalANN<1u>>(m, "PsiClassicalANN_1")
        ...
        .def_property_readonly("M_2", [](const PsiClassicalANN<1u>& psi){return psi.M_2_op.to_expr_list();})
        .def_property_readonly("M_1_squared", [](const PsiClassicalANN<1u>& psi){return psi.M_1_squared_op.to_expr_list();})
    ...
    py::class_<PsiClassicalANN<2u>>(m, "PsiClassicalANN_2")
        ...
        .def_property_readonly("M_2", [](const PsiClassicalANN<2u>& psi){return psi.M_2_op.to_expr_list();})
        .def_property_readonly("M_1_squared", [](const PsiClassicalANN<2u>& psi){return psi.M_1_squared_op.to_expr_list();})
