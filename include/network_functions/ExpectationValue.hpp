...
public:
    ...
    template<typename Psi_t, typename Ensemble>
    complex<double> exp_sigma_z(const Operator& operator_, Psi_t& psi, Ensemble& ensemble);

    template<typename Psi_t, typename Ensemble>
    Array<complex_t> operator()(const vector<Operator>& operator_array, Psi_t& psi, Ensemble& ensemble);
    ...
    template<typename Psi_t, typename Ensemble>
    pair<Array<complex_t>, complex<double>> gradient(const Operator& operator_, Psi_t& psi, Ensemble& ensemble);

    template<typename Psi_t, typename Ensemble>
    pair<Array<complex_t>, Array<double>> gradient_with_noise(const Operator& operator_, Psi_t& psi, Ensemble& ensemble);
    ...
    template<typename Psi_t, typename Ensemble>
    inline xt::pytensor<complex<double>, 1u> __call__array(const vector<Operator>& operator_, Psi_t& psi, Ensemble& ensemble) {
    ...
    template<typename Psi_t, typename Ensemble>
    pair<xt::pytensor<complex<double>, 1u>, complex<double>> gradient_py(const Operator& operator_, Psi_t& psi, Ensemble& ensemble) {
